...
void TypeChecker::endVisit(Literal const& _literal)
{
	if (_literal.looksLikeAddress())
	{
		...
		{
			msg = "This looks like an address but it is bigger than a STARKNET_FIELD_PRIME. For more information please see https://starknet.io/docs/how_cairo_works/cairo_intro.html#field-elements";
		}
